...
import mk.com.findsellgive.adapters.MyWishlistRecyclerViewAdapter;
import mk.com.findsellgive.models.WishListPost;


public class MyWishlistFragment extends ProfileBaseFragment {
    private RecyclerView rvMessages;
    private MyWishlistRecyclerViewAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new MyWishlistRecyclerViewAdapter(posts);
    ...
    private void initRecyclerView(RecyclerView recyclerView, MyWishlistRecyclerViewAdapter adapter) {
