...
public class GiveProductFragment extends HomeBaseFragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getProductByPurpose(1);
        return fragmentView;
    }

    public static GiveProductFragment newInstance() {
        return new GiveProductFragment();
    }
